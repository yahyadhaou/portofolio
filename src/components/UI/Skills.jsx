...
const Skills = () => {
  ...
  return (
    ...
    <div style={{ maxWidth: "1580px" }} className="mx-auto p-4 flex flex-col justify-center w-full h-full text-white">
      <div>
        <p style={{ fontSize: "2rem", fontWeight: "bold", borderBottom: "4px solid #718096", padding: "0.5rem 0", color:"white" }} className="inline-block">
          Skills
        </p>
        <p style={{ paddingTop: "1.5rem", color:"white"}}>These are the technologies I ve worked with</p>
      </div>
